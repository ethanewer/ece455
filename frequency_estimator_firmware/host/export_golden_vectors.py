...
Usage:
    python3 frequency_estimator_firmware/host/export_golden_vectors.py
    python3 frequency_estimator_firmware/host/export_golden_vectors.py --check
"""
import hashlib
import json
import sys
...
def vectors():
    ...
    for i_f, f_l in enumerate(FREQS):
        b = f_l / physics.GAMMA_HZ_PER_T      # b_tesla giving this f_L
