...
> now live EXCLUSIVELY in the C core (`frequency_estimator_firmware/core/`: freq_est.c = zoom,
...
> The current regression checks live in `tests/test_crb.py` and the firmware host tests.
