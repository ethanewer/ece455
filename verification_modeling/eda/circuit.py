"""Validated, JSON-serializable component and net representation.

EDA adapters may use this small dictionary format without coupling analysis
code to a particular schematic tool:
