 ...
 *
 * The simplest estimator in the family: magnitude peak of the zero-padded
 * FFT (FE_ZERO_PAD x) with log-parabolic interpolation. Known to be biased
 * on damped sinusoids (the decay broadens the peak) and resolution-limited
 * to ~1/T_record; it exists in this core so the FFT-peak algorithm is a
 * legal CANDIDATE ESTIMATOR VARIANT scored through the identical E2E path
 * as the zoom core (REDESIGN.md section 2) -- not a parallel Python
 * reference.
 *
